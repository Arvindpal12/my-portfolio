...
const Navbar = () => {
    ...
    return (
        <nav className='flex flex-wrap justify-between md:item-center text-white px-10 pt-6 md:px-20'>
            ...
            <ul className={`${manu ? "black" : "hidden"}  mx-24 p-y2 mt-4 font-semibold md:mt-5 bg-black px-2 rounded-xl bg-opacity-30 md:border-none text-center md:bg-transparent md:static md:mx-0 md:flex gap-6`}>

                <a href="#About"> <li className='text-md  text-white px-4
             py-2 rounded transition-all duration-300  hover:bg-indigo-900 hover:text-white hover:shadow-lg hover:scale-105 '>About</li></a>
